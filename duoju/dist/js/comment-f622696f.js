...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"iscroll-infinite\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
	...
	*/
	...
	function loaded () {
	    myScroll = new IScroll('#commentTpl', {
	        mouseWheel: true,
	        infiniteElements: '.comment-bd li',
	        //infiniteLimit: 2000,
	        dataset: requestData,
	...
	/*    ajax('dataset.php?start=' + +start + '&count=' + +count, {
	    ...
	    $.ajax({
	        ...
	        success:function(data){
	            data = JSON.parse(data);
	            myScroll.updateCache(lastId, data);
	        }
	    });
	...
	/*
	        if(list.length > 0){
	             ...
	             <div class="comm-top">
	                    <span class="avatar">
	                        <img src="<%= list[i].user.smallAvatar%>" alt="<%=list[i].user.username%>">
	                    </span>
	                    <span class="uname">
	                        <%=list[i].user.username%>
	                    </span>
	                    <span class="time">
	                        <%=dateFormat(list[i].addTime,11,5) %>
	                    </span>
	                </div>
	                <div class="comm-con">
	                    <%=list[i].content%>
